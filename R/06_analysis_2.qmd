...
We start by dividing the patients into two groups by creating a new variable metastasis containg

-   0 for the patient without metastasis (i. e. No_stage equals to 1, 2 or 3)

1 for the patients with metastis (i. e. No_stage equals to 4)

The, we pivot the data, so we can work *per gene*, then group per gene and nest the data.
...
The above plot show the 95% confidence interval of the estimates of the expression level of the significant genes: 12 are up-regulated, whereas 8 are down-regulated.
...
Among the 2,905 genes analyzed, 43 were identified as significantly associated with the development of early metastasis. 14 genes were significantly down-regulated, while 29 genes were found to be significantly up-regulated in patients with early metastasis compared to those without it.
