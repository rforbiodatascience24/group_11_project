...
::: columns ::: {.column width="50%" height="auto" style="font-size: 22px"} \# **Cleaning row value**
...
::: columns
::: {.column width="50%"}
![](images/05_pca_scree_plot.png){width="530" height="306"}

![](images/05_pca_gender.png){width="537" height="320"}
:::

::: {.column width="50%"}
![](images/05_pca_Dukes_stages.png)

![](images/05_pca_location.png){width="520" height="275"}
:::
:::

## Gene regulation and metastasis
...
![](images/06_analysis_volcano-03.png)
